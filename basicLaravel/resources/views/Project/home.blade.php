...
@section('title',  "Health Land | Home")
    ...
    <div class="container">
      ...
      <section class=" wow fadeInLeft Slow">
        ...
        <div class="row pt-2">
          ...
          <!--Grid column-->
          <div class="col-md-6 col-sm-12 MarginAccordion col-xs-12 thai-massage rounded d-none d-sm-block" id="Show-img-first">
      ...
      <div class="pt-5  Center wow fadeIn Slow">
        <img width="600" height="20" src="img/divider-2.png"  id="dividerCenter1"/>
      </div>
      <div class="pt-5  Center wow zoomIn Slow">
        <img width="100" height="40" src="img/divider-5.png"  id="dividerCenter2"/>
      </div>
      <div class="pt-5 pr-2 Center wow fadeIn Slower">
        <img width="600" height="20" src="img/divider-3.png"  id="dividerCenter3"/>
      </div>
      ...
      <section class="mt-5">
        ...
        <div class="row wow fadeInRight Slow">
          ...
          <!--Grid column-->
          <div class="col-md-6 col-sm-12 MarginAccordion col-xs-12 DreamPackage rounded d-none d-sm-block" id="Show-img-second">
          ...
          <div class="col-md-12 col-sm-12 col-xl-12 mt-5 zoomIn Slower ">
            <div class="container">
              <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img class="d-block w-100" src="img/Discount.jpg" alt="First slide">
                  </div>
                  <div class="carousel-item">
                    <img class="d-block w-100" src="img/MemberShip.jpg" alt="Second slide">
                  </div>
                </div>
